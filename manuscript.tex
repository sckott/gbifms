...
registry, species names, occurrences, and maps. We ignore maps in
...
of registry, species names, and occurrences - we'll go through each in
...
\CommentTok{#> 1  657590544              NA               NA}
\CommentTok{#> 2  657679551              NA               NA}
\CommentTok{#> 3  657791316        37.70805        -118.4162}
\CommentTok{#> 4  658180562              NA               NA}
\CommentTok{#> 5  441881672              NA               NA}
\CommentTok{#> 6  911596181              NA               NA}
\CommentTok{#> 7   56454601              NA               NA}
\CommentTok{#> 8  657848913              NA               NA}
\CommentTok{#> 9  658187373              NA               NA}
\CommentTok{#> 10 658279212        38.95917        -106.9892}
\CommentTok{#> ..       ...             ...              ...}
\end{Highlighting}
\end{Shaded}
