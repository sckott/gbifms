...
although we do have a simple wrappar around `ggplot2` to make it easy to
...
Another package, [spoccutils][spoccutils]
...
Some of the GBIF taxonomic services are also avialable in [taxize][taxize],
...
pacakages to clean and vizualize the data.

# Use cases

The following are three use cases for `rgbif`: niche modelling,
...
Foundation (Grant 2013-6-22), and the Helmsley Foundation
(Grant XXXXXX).
...
[spoccutils]: https://github.com/ropensci/spocc
