...
the Python programming environment [@python]. Python is a general
...
less than R for ecology/biology.
...
publicly on GitHub at [https://github.com/sckott/pygbif][ghpygbif], where
...
ignore maps in both libraries as it is concerned with generating maps primarily for web
applications. Both libraries have a suite of functions dealing with each of registry, taxonomic
...
The `pygbif` library is still in early development, and will
